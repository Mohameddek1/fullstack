...
def course_success(request):
    ...
    messages.success(request, "Course purchase successful!")
    # Redirect to the course list page upon successful course purchase
    return redirect("course_list")

@login_required
def course_cancel(request):
    # Add a cancel message
    messages.info(request, "Course purchase canceled.")
    # Redirect to the course list page if the purchase is canceled
    return redirect("course_list")